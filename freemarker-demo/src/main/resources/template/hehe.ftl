...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet" xmlns:o="urn:schemas-microsoft-com:office:office"
    ...
    <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
        <Author>惊执</Author>
        <LastAuthor>87112</LastAuthor>
        <Created>2015-06-05T18:19:00Z</Created>
        <LastSaved>2020-02-17T07:18:18Z</LastSaved>
    </DocumentProperties>
    ...
    <Styles>
        ...
        <Style ss:ID="s50">
            ...
            <Font ss:FontName="Courier New" x:CharSet="134" ss:Size="12" ss:Color="#660E7A" ss:Bold="1"/>
        </Style>
        <Style ss:ID="s51">
    ...
    <Worksheet ss:Name="Sheet1">
        <Table ss:ExpandedColumnCount="5" ss:ExpandedRowCount="2" x:FullColumns="1" x:FullRows="1"
               ss:DefaultColumnWidth="48.6" ss:DefaultRowHeight="13.8">
            <Column ss:Index="3" ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="115.8"/>
            <Column ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="171"/>
            <Column ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="139.8"/>
            <Row>
                <Cell>
                    <Data ss:Type="String">图书编号</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="String">图书名称</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="String">图书价格</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="String">是否上架</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="String">出版日期</Data>
                </Cell>
            </Row>
            <#list bookList as book>
            <Row ss:Height="16.2">
                <Cell ss:StyleID="s50">
                    <Data ss:Type="String">${book.bookId}</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="String">${book.bookName}</Data>
                </Cell>
                <Cell ss:StyleID="s51">
                    <Data ss:Type="String">${book.bookPrice}</Data>
                </Cell>
                <Cell>
                    <Data ss:Type="String">${(book.isup==1)?string("是","否")}</Data>
                </Cell>
                <Cell ss:StyleID="s52">
                    <Data ss:Type="String">${book.producedDate?datetime}</Data>
                </Cell>
            </Row>
            </#list>
        </Table>
        <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
            ...
            <Panes>
                <Pane>
                    ...
                    <RangeSelection>R12C5</RangeSelection>
                </Pane>
            </Panes>
